...
class InterDenoiser_Duet(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(num_layers):
            self.blocks.append(DoubleTransformerBlock(num_heads=num_heads,latent_dim=latent_dim, dropout=dropout, ff_size=ff_size))
        # Output Module
...
class InterDiffusion_Duet(nn.Module):
    # TODO: it needs to be verified
    def __init__(self, cfg, sampling_strategy="ddim50"):
        ...
        # NOTE: interdenoiser duet
        self.net = InterDenoiser_Duet(self.nfeats, self.latent_dim, ff_size=self.ff_size, num_layers=self.num_layers,
